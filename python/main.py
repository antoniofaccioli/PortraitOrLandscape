...
def initLn():
    ...
    if language == "it":
        ...
        "OptionLabel1" : "Setzen Sie Seite 1 mit dem Stil \"Erste Seite\" und fügen Sie eine Unterbrechung mit dem Stil \"Standardstil\" ein.",
        "OptionLabel2" : "Erstellen Sie drei durch Unterbrechungen getrennte Seiten mit den folgenden Stilen: 1) Erste Seite, 2) Standardstil, 3) Rechte Seite",
        "OptionLabel3" : "Stellen Sie Seite 1 mit dem Stil \"Erste Seite\" ein und fügen Sie eine Unterbrechung mit dem Stil \"Standardstil\" ein. Im Folgenden werden die Stile \"Rechts/Links\" verwendet",
        "OptionLabel4" : "Stellen Sie Seite 1 mit dem Stil \"Erste Seite\" ein, die zweite verwendet den \"Standardstil\". Ab dem dritten wechseln sich die Stile \"Rechts/Links\" ab",
        "OptionLabel5" : "Stellen Sie Seite 1 als \"Erste Seite\" und die folgenden Seiten als \"Links\" und \"Rechts\" ein.",
        "CancelLabel" : "Stornieren",
        "TitleInformation" : "Informationen",
